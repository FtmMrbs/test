...
################################################################
# This is a generated script based on design: BLINK_Z0_Block
#
...
# source BLINK_Z0_Block_script.tcl
...
set design_name BLINK_Z0_Block
...
proc create_root_design { parentCell } {
  ...
  # Create instance: BLINK_Z00_0, and set properties
  set block_name BLINK_Z00
  set block_cell_name BLINK_Z00_0
  if { [catch {set BLINK_Z00_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $BLINK_Z00_0 eq "" } {
  ...
  connect_bd_net -net BLINK_Z00_0_LEDs [get_bd_ports LEDs] [get_bd_pins BLINK_Z00_0/LEDs]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins BLINK_Z00_0/Clock] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]

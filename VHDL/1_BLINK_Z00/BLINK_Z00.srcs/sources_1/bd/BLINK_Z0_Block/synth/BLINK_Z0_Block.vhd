...
--Date        : Mon May  8 19:13:39 2023
--Host        : DESKTOP-C1H43J3 running 64-bit major release  (build 9200)
--Command     : generate_target BLINK_Z0_Block.bd
--Design      : BLINK_Z0_Block
...
entity BLINK_Z0_Block is
  ...
  attribute CORE_GENERATION_INFO of BLINK_Z0_Block : entity is "BLINK_Z0_Block,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BLINK_Z0_Block,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of BLINK_Z0_Block : entity is "BLINK_Z0_Block.hwdef";
end BLINK_Z0_Block;

architecture STRUCTURE of BLINK_Z0_Block is
  component BLINK_Z0_Block_processing_system7_0_0 is
  port (
  ...
  end component BLINK_Z0_Block_processing_system7_0_0;
  component BLINK_Z0_Block_BLINK_Z00_0_0 is
  port (
    Clock : in STD_LOGIC;
    LEDs : out STD_LOGIC_VECTOR ( 2 downto 0 )
  );
  end component BLINK_Z0_Block_BLINK_Z00_0_0;
  signal BLINK_Z00_0_LEDs : STD_LOGIC_VECTOR ( 2 downto 0 );
...
begin
  LEDs(2 downto 0) <= BLINK_Z00_0_LEDs(2 downto 0);
BLINK_Z00_0: component BLINK_Z0_Block_BLINK_Z00_0_0
     port map (
      Clock => processing_system7_0_FCLK_CLK0,
      LEDs(2 downto 0) => BLINK_Z00_0_LEDs(2 downto 0)
    );
processing_system7_0: component BLINK_Z0_Block_processing_system7_0_0
     port map (

...
HD_PWD='F:/TUTORIAL/FPGA/fpga-saghafi/Digital_design/08/BLINK_Z00/BLINK_Z00.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BLINK_Z0_Block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BLINK_Z0_Block_wrapper.tcl

...
HD_PWD='F:/TUTORIAL/FPGA/fpga-saghafi/Digital_design/08/BLINK_Z00/BLINK_Z00.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BLINK_Z0_Block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BLINK_Z0_Block_wrapper.tcl -notrace
